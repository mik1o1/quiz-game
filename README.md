...
<!-- PROJECT LOGO -->
<div align="center">
<a href="https://Chewata Trivia.vercel.app"><img src="./readme/header.webp" alt="Instagram" /></a>
<br/>
<br />
...
A quiz/trivia game with different modes and categories that you can select, as well as wildcards to help you. The questions are generated by artificial intelligence using the [Cohere API](https://dashboard.cohere.ai/welcome/register).
  ...
  <a href="https://Chewata Trivia.vercel.app">View Demo</a>
  ·
...
Chewata Trivia is a quiz/trivia game made with with [Cohere](https://cohere.ai). You can select different game modes and topics, you also have wildcards. Cohere's AI will generate the questions and answers for you.
